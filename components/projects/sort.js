                ...
                <div className='w-[171px] h-[35px]'>
                    <select
                      ...
                      text-theme border-[1px] focus:border-theme focus:outline-none border-inputBorderColor text-[14px] ">
                        {/* <option value='none'>Sort by Name (A-Z)</option> */}
                        <option className="text-[16px] font-sans  not-italic font-normal text-[#000000]" value='a-z'>Sort by Name (A-Z)</option>
                        <option className="text-[16px] font-sans  not-italic font-normal text-[#000000]" value='status'>Sort by Status</option>
                        <option className="text-[16px] font-sans  not-italic font-normal text-[#000000]" value='services'>Sort by Service / Industry</option>
                    </select>
                </div>
