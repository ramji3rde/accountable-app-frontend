...
import { deleteExpenseAPI } from "../../redux/APIS/API";
...
function DeletePopup(props) {
    ...
    const expensesId = useSelector((state) => state?.expenseDetails?.expenseDetails?.data?.expense_id)
    ...
    async function deleteUser() {
        try {
            ...
            const respon = await deleteExpenseAPI({
                "expense_ids": [expensesId]
            })
