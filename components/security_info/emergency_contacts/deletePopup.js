...
import { deleteEmergencyContactAPI } from "../../../redux/APIS/API";
...
function DeletePopup(props) {
    ...
    const emergencyId = useSelector((state) => state?.emergencyDetails?.emergencyDetails?.data?.emergency_id)
    ...
    async function deleteUser() {
        try {
            ...
            const respon = await deleteEmergencyContactAPI({
                "emergency_ids": [emergencyId]
            })
